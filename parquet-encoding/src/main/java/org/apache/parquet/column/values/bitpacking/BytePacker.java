...
public abstract class BytePacker {
   ...
   * @param outPos where to write to in output
   */
  public void pack8Values(final long[] input, final int inPos, final byte[] output, final int outPos) {}
   ...
   * @param outPos where to write to in output
   */
  public void pack32Values(long[] input, int inPos, byte[] output, int outPos) {}
   ...
   * @param outPos where to write to in output
   */
  public void unpack8Values(final byte[] input, final int inPos, final long[] output, final int outPos) {}
   ...
   * @param outPos where to write to in output
   */
  public void unpack32Values(byte[] input, int inPos, long[] output, int outPos) {}
