...
public class DeltaBinaryPackingValuesWriterForInteger {
  ...
  public DeltaBinaryPackingValuesWriterForInteger(final DeltaBinaryPackingConfig config) {
    this.config = config;
  ...
  public void writeInteger(int v, final CapacityByteArrayOutputStream baos) {
    totalValueCount++;
